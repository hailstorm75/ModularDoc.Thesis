...
\begin{multicols}{2}
    ...
    \begin{description}
        ...
        \item [\namedlabel{itm:solid}{SOLID}] Single Responsibility Principal, Open-Closed Principle, Liskov Substitution Principle, Interface Segregation Principle, Dependency Inversion Principle
