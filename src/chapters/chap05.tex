...
Applying \ref{itm:solid} principles helped design an architecture of a maintainable and extendable application.
The primary principle, Single-responsibility, helps separate operations within the application into key parts (see \ref{sec:keyParts}), where
each part plays its individual key role in the application.
