...
Completing all these steps will be the solution to the goal of this thesis. For the sake of simplicity, said libraries will be developed specifically for processing \ref{gloss:dotnetlabel} projects written in C\#.
