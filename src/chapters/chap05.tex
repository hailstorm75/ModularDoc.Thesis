...
\begin{enumerate}
    ...
    \item \label{num:stage6} Create the composer component
    \item \label{num:stage7} Create the printer component
    \item \label{num:stage8} Create the \ref{gloss:markdown} plugin
    \item \label{num:stage9} Create the \ref{itm:ui} application
\end{enumerate}
