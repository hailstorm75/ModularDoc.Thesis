...
A clearer picture of developer needs can be drawn from the collected responses.
The main takeaway is that the majority neglets the importance of documenting code; thus, those who do and actually use documentation generating tools are part of a minute subset of all developers (see figure \ref{fig:qUsingToolsForDocGen}).