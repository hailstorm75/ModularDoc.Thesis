...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Create a type representing the plugin instance, inherit the plugin interface from the referenced core library, and inherit the \textit{Autofac.Module} class
