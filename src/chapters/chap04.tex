...
The proof of concept application was rapidly developed without applying DI, or respecting SOLID principles. This both helped to quickly develop a simple application, and showed that incorrect use or absence of design patterns will produce an unmaintainable application.

\subsection{Git platforms for hosting open-source projects}

The proof of concept project source code was hosted on GitLab to tests said platforms capabilities. Other platforms were not tested in the scope of this thesis; nevertheless, said platforms were tested via other personal projects.
...
Azure DevOps is a platform designed for organizations with large teams. It provides complex tools to managing said teams, and managing their projects using agile. The platform is powerful, and complex; thus, it is unsuitable for one-man projects. Additionally, since the platform is designed for organizations, it lacks tools for projects discoverability.
