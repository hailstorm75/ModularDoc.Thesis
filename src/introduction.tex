...
With that in mind, the target group for such a tool is minor. Given that, focusing on the extensibility feature of the tool is crucial to cover their needs.
