...
Since Git hosting platforms predominantly\footnote{GitLab also supports RDoc, AsciiDoc, and Org} utilize Markdown for displaying formatted text, static HTML pages aren't directly supported.
