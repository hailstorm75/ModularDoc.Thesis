...
\begin{description}
    ...
    \item [\namedlabel{gloss:git}{Git}] A free and open-source distributed version control system designed to handle everything from small to substantial projects with speed and efficiency \cite{git_git_2022}
